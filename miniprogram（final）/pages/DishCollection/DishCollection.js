...
Page({
  ...
  // dish_collection_gotocaipu: function () { wx.navigateTo({ url: '../DishCollection/DishCollection', }) },
  // dish_collection_gotowenzhang: function () { wx.navigateTo({ url: '../ArticleCollection/ArticleCollection', }) },
  /**
   * 生命周期函数--监听页面加载
   */
